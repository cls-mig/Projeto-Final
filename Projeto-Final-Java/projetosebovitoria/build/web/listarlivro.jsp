...
<body>
    ...
    %>
    <h1 class="title-table">Selecione o livro</h1>
    ...
    <table id="myTable">
        <tr class="header">
            ...
            <c:forEach items="${list}" var="livro">
                <tr>
                    <td style="display: none;">${livro.getId()}</td>
                    ...
                    <td style="white-space: nowrap;"><a href="cadastrarexemplar.jsp?id=${livro.getId()}">Adicionar</a></td>
                </tr>
            </c:forEach>
    </table>
</body>
